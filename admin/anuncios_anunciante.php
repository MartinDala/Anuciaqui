...
$id=$_GET['usuario'];
$pub = mysqli_query($banco,"SELECT * FROM publicar WHERE usuario='$id'  ORDER BY visitas");
...
<div id="bemvindo" style="background-color: transparent; margin-left: 26%;color: #fff;margin-top: 10px">
		 <h3 style="text-align: center;">LISTA DE ANUNCIOS DO ANUNCIANTE   <?php echo" ".strtoupper($id)?> </h3>
...
<div class="place" id="vivo"><hr><div class="vs">
	...
	<span><i style="color:#5C2D00;margin-left: 1%;" class="fa  fa-home"></i><?php echo $sel["local"];?></span><br>
		<span><i style="color:#5C2D00;margin-left: 1%;" class="fa fa-phone"></i> <?php echo $sel["telefone"];?></span><br>
	<span><i style="color:#5C2D00;margin-left: 9%;" class="fa fa-calendar"></i> <?php echo $sel["pdata"];?></span>
